...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            @endif
            <div class="col-md-12">
                <a href="{{url('add_contact')}}" class="btn btn-success"><i class="fa fa-plus-circle"></i> Add Contact</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="title" class="control-label label-paf">Frist Name</label>
                                    <input type="text" placeholder="FristName" class="form-control input-paf" id="firstname" />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
