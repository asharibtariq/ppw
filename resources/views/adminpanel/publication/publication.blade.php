...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            @endif
            <div class="col-md-12">
                <a href="{{url('add_publication')}}" class="btn btn-success"><i class="fa fa-plus-circle"></i> Add Publication</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="title" class="control-label label-paf">Title</label>
                                    <input type="text" placeholder="Title" class="form-control input-paf" id="title" />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
