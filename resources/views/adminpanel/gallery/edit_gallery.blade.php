            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{url('update_gallery', $gallery->id)}}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="label-paf" for="image">
                                            @if ($gallery->image != '')
                                                <img src="{{asset('uploads/gallery/'.$gallery->image)}}" width="50" />
                                            @else
                                                Image
                                            @endif
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control input-paf" name="status" id="status">
                                            <option value="Y" {{$gallery->status == "Y" ? "selected" : ""}}>Active</option>
                                            <option value="N" {{$gallery->status == "N" ? "selected" : ""}}>In-Active</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-8">
