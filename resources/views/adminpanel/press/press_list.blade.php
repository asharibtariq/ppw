    ...
    @if(is_array($result) && count($result) > 0)
        @foreach ($result as $r)
            ...
            <tr role="row">
                ...
                <td>
                    <a onClick="return confirm('Are you sure you want to update?');" href="{{url('edit_press', $r->id)}}" class="btn btn-info" id="btn-view"><i class="fa fa-edit"></i> Edit</a>
                    <a onClick="return confirm('Are you sure you want to delete?');" href="{{url('delete_press', $r->id)}}" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</a>
                </td>
            </tr>
            @php
                $i++;
