            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{url('update_press', $press->id)}}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="label-paf" for="document">
                                            @if ($press->document != '')
                                                <img src="{{asset('uploads/press/'.$press->document)}}" width="50" />
                                            @else
                                                Document
                                            @endif
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control input-paf" name="status" id="status">
                                            <option value="Y" {{$press->status == "Y" ? "selected" : ""}}>Active</option>
                                            <option value="N" {{$press->status == "N" ? "selected" : ""}}>In-Active</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-8">
