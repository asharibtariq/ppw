					...
					<div class="article-comments">
						...
						<div class="media">
							<div class="media-left">
								<img class="media-object" src="{{asset('img/xavatar-1.jpg.pagespeed.ic.RkR3XY-knB.jpg')}}" alt="">
							</div>
							...
							<div class="media">
								<div class="media-left">
									<img class="media-object" src="{{asset('img/xavatar-2.jpg.pagespeed.ic.lZk0jiPD8Z.jpg')}}" alt="">
								</div>
								<div class="media-body">
									<div class="media-heading">
										<h4>Joe Doe</h4>
